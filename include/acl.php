...
function bbcc_acl_page_rules(): array {
    return [
        ...
        'admin-donation-verification' => ['admin'],
        'donationsetting' => ['admin'],
        'admin-parent-pins' => ['admin'],
        'mail-test' => ['admin'],
        'run-migration' => ['admin'],
        'manual-payments' => ['admin'],
        'exportstudents' => ['admin'],
        'exportstudentpaymentdetails' => ['admin'],
        'regenerate-image-variants' => ['admin', 'website_admin'],
        'bannersetup' => ['admin', 'website_admin'],
        'chedtshogcontentsetup' => ['admin', 'website_admin'],
        'taracontentsetup' => ['admin', 'website_admin'],
        'programdetailssetup' => ['admin', 'website_admin'],
...
function bbcc_acl_route_module_rules(): array {
    return [
        ...
        'chedtshogcontentsetup' => ['website', 'manage'],
        'taracontentsetup' => ['website', 'manage'],
        'programdetailssetup' => ['website', 'manage'],
        'serviceprogramssetup' => ['website', 'manage'],
        ...
        'student-profile' => ['enrollment', 'view'],
        ...
        'admin-class-students' => ['classes_attendance', 'manage'],
        ...
        'exportstudents' => ['reports_settings', 'export'],
        'exportstudentpaymentdetails' => ['reports_settings', 'export'],
