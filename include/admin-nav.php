...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" role="navigation" aria-label="Main sidebar navigation">
    ...
    <?php if (!isParent() && !isTeacher() && !isPatron()) { ?>
        <?php
            $websiteActive = in_array($currentPage, ['bannerSetup.php','aboutPageSetup.php','schoolContentSetup.php','taraContentSetup.php','sponsorSetup.php','sponsorProgramDetailsSetup.php','sponsorProgramDetailEdit.php','downloadFileSetup.php','serviceSetup.php','ourTeamSetup.php','viewFeedback.php'], true);
        ...
        <li class="nav-item">
            ...
            <div id="collapseWebsite" class="collapse <?= $websiteActive ? 'show' : '' ?>">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?= in_array($currentPage, ['sponsorProgramDetailsSetup.php','sponsorProgramDetailEdit.php'], true) ? 'active' : '' ?>" href="sponsorProgramDetailsSetup"><i class="fas fa-file-alt fa-sm mr-1 text-muted"></i> Setup Program Details</a>
