-- ==========================================================
-- Full Database Dump: restWeb_db
-- Generated: 2026-02-22 14:41:14
-- Server: MySQL 8.1.0
-- ==========================================================

CREATE DATABASE IF NOT EXISTS `restWeb_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `restWeb_db`;

-- MySQL dump 10.13  Distrib 9.3.0, for macos14.7 (arm64)
--
-- Host: localhost    Database: restWeb_db
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'restWeb_db'
--
