-- ================================================================
-- Parent Class Management System — Fresh Database Migration
-- Author: GitHub Copilot  |  Date: 2026-02-19
-- Run AFTER dbScript.sql tables exist.
...
-- ---------------------------------------------------------------
-- 2) Bank accounts (admin-managed, shown to parents at enrolment)
-- ---------------------------------------------------------------
...
-- ---------------------------------------------------------------
-- 3) Enrolment requests (parent submits, admin approves/rejects)
-- ---------------------------------------------------------------
...
-- ---------------------------------------------------------------
-- 4) Fee payments (one row per instalment per student)
-- ---------------------------------------------------------------
...
-- ---------------------------------------------------------------
-- 6) Absence requests (parent submits, admin approves/rejects)
-- ---------------------------------------------------------------
...
-- ================================================================
-- Done.  New tables prefixed  pcm_  to avoid clashing with
-- existing Dzo Class Management tables.
-- ================================================================
